...
ROUTER_MODULES: Tuple[RouterModule, ...] = (
    ...
    RouterModule("quirofano_web", "quirofano", "Quirófano web", (RouterSpec("app.routers.quirofano_web"),)),
    ...
    RouterModule("expediente_web", "expediente", "Expediente web", (RouterSpec("app.routers.expediente_web"),)),
