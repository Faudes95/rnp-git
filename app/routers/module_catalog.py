...
ROUTER_MODULES: Tuple[RouterModule, ...] = (
    ...
    RouterModule("fhir", "fhir", "FHIR", (RouterSpec("app.api.fhir"),)),
    ...
    RouterModule("ai_fau_bot", "ia", "FAU-BOT", (RouterSpec("app.api.fau_bot"),)),
    RouterModule("ai_fau_bot_core", "ia", "FAU-BOT Core", (RouterSpec("app.api.fau_bot_core"),)),
